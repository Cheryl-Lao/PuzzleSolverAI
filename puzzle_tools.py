...
def depth_first_solve(puzzle):
    ...
    # If there are extensions to this puzzle configuration
    if puzzle.extensions:

        # Call some other function to get a list of solution nodes?
        return #The solution with the smallest solving time??
